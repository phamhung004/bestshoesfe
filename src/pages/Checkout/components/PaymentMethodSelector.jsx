                            ...
                            <div className="co-pay-expand">
                                <div className="co-pay-bank-info">
                                    ...
                                    <div className="co-pay-bank-row">
                                        ...
                                        <span className="co-pay-bank-value">Vietcombank</span>
                                    </div>
                                    <div className="co-pay-bank-row">
                                        <span className="co-pay-bank-label">Số TK:</span>
                                        <span className="co-pay-bank-value">1234567890</span>
                                        <button
                                            className="co-pay-copy-btn"
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                onCopyBankAccount('1234567890');
                                            }}
                                        >
                                            Sao chép
                                        </button>
                                    ...
                                    <div className="co-pay-bank-row">
                                        ...
                                        <span className="co-pay-bank-value">CÔNG TY BESTSHOES</span>
                                    </div>
                                    <div className="co-pay-bank-row">
                                        <span className="co-pay-bank-label">Nội dung CK:</span>
                                        <span className="co-pay-bank-value">[Mã đơn hàng] [SĐT]</span>
                                    </div>
