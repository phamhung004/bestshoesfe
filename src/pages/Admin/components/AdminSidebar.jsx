        ...
        <div className="admin-sidebar">
            ...
            <nav className="sidebar-nav">
                {menuItems.map((item) => (
                    <div key={item.id} className="menu-item-container">
                        <div
                            className={`menu-item ${item.type === "parent" ? "menu-item-parent" : ""} ${activeSection === item.id ||
                                    activeSection.startsWith(`${item.id}/`)
                                    ? "menu-item-active"
                                    : ""
                                }`}
                        ...
                        >
                            <div className="menu-item-content">
                                ...
                                {item.type === "parent" && (
                                    <span
                                        className={`menu-arrow ${expandedItems[item.id] ? "expanded" : ""}`}
                                    >
                                        ▼
                                    </span>
                                )}
                        ...
                        {item.type === "parent" && expandedItems[item.id] && (
                            <div className="submenu">
                                {item.children.map((child) => (
                                    <div
                                        key={child.id}
                                        className={`submenu-item ${activeSection === `${item.id}/${child.id}`
                                                ? "submenu-item-active"
                                                : ""
                                            }`}
                                        onClick={() => handleItemClick(child.id, "child", item.id)}
